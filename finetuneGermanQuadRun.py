...
if "german-fin" in modelPath:
    pathBase = "GermanFinBERT\\"+modelName+"\\GermanQuAD"
else:
    pathBase = "Benchmarks\\"+modelName+"\\GermanQuAD"
if not os.path.exists(pathBase):
    os.makedirs(pathBase)
for seed in range(numSeeds):
    datasets = load_dataset("deepset/germanquad")
    ...
    args = TrainingArguments(
        f"{modelName}-finetuned-germanquad",
    ...
    trainer.train()
    shutil.rmtree(f"{modelName}-finetuned-squad")
