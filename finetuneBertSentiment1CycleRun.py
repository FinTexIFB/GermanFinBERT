...
# Load data
#Train
train_data = pd.read_parquet(r"..\..\FinetuneData\sentiment\train.parquet")
train_data,encoder,classes = Encoder(train_data)
train_dataset = Dataset.from_pandas(train_data)
# Val
val_data = pd.read_parquet(r"..\..\FinetuneData\sentiment\validation.parquet")
val_data = Encoder(val_data,label_encoder=encoder)
val_dataset = Dataset.from_pandas(val_data)
# Test
test_data = pd.read_parquet(r"..\..\FinetuneData\sentiment\test.parquet")
