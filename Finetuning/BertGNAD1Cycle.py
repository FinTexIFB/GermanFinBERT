...
#%% Hyperparameters
classes = pd.read_pickle("..\..\FinetuneData\GNAD\classNames.pkl")
seeds=5
...
# Load data
#Train
train_data = pd.read_parquet(r"..\..\FinetuneData\GNAD\train.parquet")
train_data = train_data.rename(columns={"text":"sentence"})
train_dataset = Dataset.from_pandas(train_data)
#Val
val_data = pd.read_parquet(r"..\..\FinetuneData\GNAD\val.parquet")
val_data = val_data.rename(columns={"text":"sentence"})
val_dataset = Dataset.from_pandas(val_data)
#Test
test_data = pd.read_parquet(r"..\..\FinetuneData\GNAD\test.parquet")
