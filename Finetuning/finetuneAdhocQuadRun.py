...
for seed in range(numSeeds):
    datasets = load_dataset("scherrmann/adhoc_quad")
    ...
    final_predictions = postprocess_qa_predictions(datasets["validationt"], validation_features, raw_predictions.predictions, tokenizer)
